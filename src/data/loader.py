...
class DataLoader:
    ...
    Handles fetching, cleaning, and scaling medical datasets for FHE compatibility.
    """
    def __init__(self, dataset="uci"):
        self.dataset_name = dataset

    def load_and_split(self):
        """
        Factory method to load medical datasets.
        ...
        # Scaling is crucial for FHE Quantization stability (8-bit)
